...
final class OrganizationGet
{
    ...
    private function toResponse(): callable
    {
        return static function ($organization) {
            return new OrganizationResponse($organization['id'], $organization['parent_id'], $organization['user_id'], $organization['level'], $organization['unit_id'], $organization['user'], $organization['parent'], $organization['unit']);
        };
    }
}
